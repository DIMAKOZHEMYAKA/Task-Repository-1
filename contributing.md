Contributing to Task-Repository-1

Спасибо за интерес к вкладу в Task-Repository-1! В этом документе описаны основные правила и рекомендации для участников.
...
git clone https://github.com/DIMAKOZHEMYAKA/Task-Repository-1.git
